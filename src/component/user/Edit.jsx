...
<Input id={'username'} errors={errors} title={'user name'} type={'text'} name={'name'} value={user.name} handelDate={handelDate} />

<Input id={'email'} errors={errors} title={'user email'} type={'email'} name={'email'} value={user.email} handelDate={handelDate} />

<Input id={'password'} errors={errors} title={'user password'} type={'password'} name={'password'}  value={user.password} handelDate={handelDate} customClasses={'bg-danger'} />
