...
<Input id={'username'} errors={errors} title={'user name'} type={'text'} name={'name'} handelDate={handelDate} />

<Input id={'email'} errors={errors} title={'user email'} type={'email'} name={'email'} handelDate={handelDate} />

<Input id={'password'} errors={errors} title={'user password'} type={'password'} name={'password'} handelDate={handelDate} customClasses={'bg-danger'} />
